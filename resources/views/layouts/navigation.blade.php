        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('inbox.show')" :active="request()->routeIs('inbox.show')">
                        {{ __('Inbox') }}
                    </x-nav-link>
                    <x-nav-link :href="route('team.all')" :active="request()->routeIs('team.all')">
                        {{ __('Teams') }}
                    </x-nav-link>
                    <x-nav-link :href="route('match.all')" :active="request()->routeIs('match.all')">
                        {{ __('Matches') }}
                    </x-nav-link>
                </div>
            </div>
